		...
		<div class="topbar">
			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<button
						class="btn btn-custom btn-right disabled waves-effect waves-light" id="buttonLeave">
						<i class="fa fa-sign-out"></i> Leave
					</button>
					<button
						class="btn btn-info btn-right disabled waves-effect waves-light" id="buttonEdit">
						<i class="fa fa-pencil"></i> Edit
					</button>
					<button
						class="btn btn-custom btn-right disabled waves-effect waves-light" id="buttonAdd">
									...
									<div class="panel panel-left">
										<div class="panel-body p-t-0">
											...
											<div class="row view-header" >		
												<p class="b"><strong>List Trainer Account</strong></p>
											</div>
												...
												<table id="datatable-fixed-header" class="table ">
													<thead>
														<tr>
															...
															<th>FirstName</th>
															<th>Last Name</th>
															<th class='hidden' data-orderable="false"></th>
														</tr>
													</thead>
															...
															<tr class="part">
																...
																<td class="hidden">
																	...
																	<c:forEach var="profileUser" items="${user.profileUsers}">
																	 ...
																	 <c:forEach var="profileUser" items="${user.profileUsers}">
																		<c:if test="${profileUser.profile.name == 'Education'}">
							...
							<div class="col-sm-12">
								<div class="panel panel-right">
									<div class="panel-body p-t-0">
										...
										<div class="row view-header" >		
												<p class="b"><strong>Profile Trainer Account</strong></p>
										</div>
					...
					<div class="modal-body modalDS-body">
						<form class="form-horizontal group-border-dashed" action="#">
							...
							<div class="form-group hidden ">
								<input type="text" class="form-control" value="" id="inputProfile-ID" />
							</div>
