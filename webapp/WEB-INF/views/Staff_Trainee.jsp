				...
				<div class="modal-content modalDS-content">
					...
					<div class="modal-body modalDS-body">
						<form class="form-horizontal group-border-dashed" action="#">
							...
							<div class="form-group add-trainee hidden">
								<label class="col-sm-3 control-label lbl-left">User Name
									*</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" value="" required
										placeholder="Enter User Name..." id="inputProfile-UserName" />
								</div>
							</div>
							<div class="form-group add-trainee ">
								<label class="col-sm-3 control-label lbl-left">Password
									*</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" value="" required
										placeholder="Enter Password..." id="inputProfile-Password" />
								</div>
							</div>
							<div class="form-group add-trainee ">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" value="" required
										placeholder="Re Enter Password..." id="inputProfile-RePassword" />
								</div>
							</div>
							<div class="form-group  editt-trainee">
								<label class="col-sm-3 control-label lbl-left">Password </label>
								<div class="col-sm-8">
							...
							<div class="form-group  editt-trainee">
								<label class="col-sm-3 control-label lbl-left">Re-Password </label>
								<div class="col-sm-8">
									<input type="text" class="form-control" value="" 
										placeholder="Re Enter Password..." id="inputProfile-RePassword" />
								</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content modalDS-content">
					...
					<div class="modal-body modalDS-body">
						...
						<div class="row">
							<div class="col-md-12">
								<form action="trainee/uploadExcelFile" method="post" enctype="multipart/form-data">
									<button type="file" name="file" accept=".xls,.xlsx" class="btn btn-primary waves-effect waves-light"></button>
									<br /> 
								...
								<button type="button"
									class="btn btn-default waves-effect cancel-ImportExcel">Cancel</button>
							</div>
						</div>
