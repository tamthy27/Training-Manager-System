...
<body class="fixed-left">
											...
											<div class="m-t-20">
												...
												<div>
													...
													<c:forEach var="user" items="${listUser}" >
														<tr class="part ${user.id}">
															<td class='username'>
																<p class='username'>${user.username} </p>
																<p class='hidden id'>${user.id}</p>
																
																<c:forEach var="profileUser" items="${user.profileUsers}" >								
															...
															<td class='password'>
																<%-- <p class='col-default'>${listUser.password} </p> --%>
																<p class='col-default'>********** </p>
																<input placeholder='Enter Password...' type='password'
																	class='col-edit form-control input-block hidden' value=''/>
															</td>
															<td class='actions'>
																<a href='#' class='link link-save save-row save-AdminRow link-editing hidden'
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="panel panel-right">
									<div class="panel-body hidden p-t-0" id="profileContent">
										...
										<div class="view-body p-t-10">
											...
											<div class="row ">
												...
												<label class="col-md-8 lbl-info-detail" id="profile-FirstName"></label>
											</div>
											<div class="row ">
												
												<label class="col-md-3 lbl-info-title">Last Name</label> 
												<label class="col-md-1 lbl-info-title">:</label> 
												<label class="col-md-8 lbl-info-detail" id="profile-LastName"></label>
											</div>
											<div class="row ">
																					
												<label class="col-md-3 lbl-info-title">E-Mail</label> 
												<label class="col-md-1 lbl-info-title">:</label> 
												<label class="col-md-8 lbl-info-detail" id="profile-Email"></label>
											</div>										
											<div class="row">
												
												<label class="col-md-3 lbl-info-title">Birthday</label> 
												<label class="col-md-1 lbl-info-title">:</label> 
												<label class="col-md-8 lbl-info-detail" id="profile-Birthday"></label>
											</div>
											<div class="row ">
												
												<label class="col-md-3 lbl-info-title">Phone Number</label> 
												<label class="col-md-1 lbl-info-title">:</label> 
												<label class="col-md-8 lbl-info-detail" id="profile-PhoneNumber"></label>
											</div>
						...
						<form class="form-horizontal group-border-dashed" action="#">
							...
							<div class="form-group">
								<div class="col-sm-offset-8 col-sm-4 m-t-15">
									...
									<button type="submit" id="save-model-edit-profile"
										class="btn btn-primary waves-effect waves-light">
										Save</button>
	...
	<!-- init -->
	<script src="<c:url value = '/static/pages/admin_staff.js'/>"></script>	
